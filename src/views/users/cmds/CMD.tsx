  ...
  const fetchData = async () => {
    try {
      ...
      const [rolesResponse, usersResponse, hospitalsResponse] = await Promise.all([
        ...
        axios.get(`${process.env.NEXT_PUBLIC_APP_URL}/cmds`, {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_APP_URL}/cmds`,
        newUser,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      setUsers((prevUsers) => [
        ...prevUsers,
        {
          ...
          hospitalName: response.data.user.hospital_admins.hospital.hospitalName,
        },
      ]);
