    ...
    const fetchData = async () => {
      try {
        ...
        const [rolesResponse, usersResponse, hospitalsResponse] = await Promise.all([
          axios.get(`${process.env.NEXT_PUBLIC_APP_URL}/roles/hospital`, {
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${token}`,
            },
          }),
          axios.get(`${process.env.NEXT_PUBLIC_APP_URL}/hospital-staff`, {
            headers: {
              'Content-Type': 'application/json',
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_APP_URL}/hospital-staff`,
        newUser,
        {
          headers: {
            "Content-Type": "application/json",
