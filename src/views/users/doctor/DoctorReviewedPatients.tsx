...
const DoctorReviewedPatientsTable = () => {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.NEXT_PUBLIC_APP_URL}/patient/doctor/reviewed`, {
...
export default DoctorReviewedPatientsTable;
