...
const [value, setValue] = useState(new Date()); // Set initial time to current time
  ...
  const handleTimeChange = (newTime) => {
    ...
    handleFormChange('billingTime', formattedTime);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
        ...
        billingTime: formData.billingTime,
  ...
  <TextField
    ...
    onChange={e => handleFormChange('billingDate', e.target.value)}
    InputLabelProps={{
...
export default CreateEncounterBilling
