...
const handleSubmit = async (event) => {
  ...
  try {
    ...
    if (response.status === 201) {
      ...
      setHospitals((prevHospitals) => [newHospital, ...prevHospitals]);
          ...
          <TableBody>
            {displayedHospitals.map((hospital) => (
              <TableRow key={hospital.id}>
                ...
                <TableCell>{hospital?.hospitalDescription}</TableCell>
                <TableCell>{hospital?.hospitalType}</TableCell>
                <TableCell>{hospital?.hospitalCategory}</TableCell>
                <TableCell>₦{hospital?.hospitalCost ? new Intl.NumberFormat().format(hospital.hospitalCost) : "N/A"}</TableCell>
        ...
        <DialogContent>
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth margin="dense">
              ...
              <Select name="hospitalType" value={formData.hospitalType} onChange={handleInputChange} required>
            ...
            {formData.hospitalType === 'Medicine' && (
              <FormControl fullWidth margin="dense">
                <InputLabel>Category</InputLabel>
                <Select name="hospitalCategory" value={formData.hospitalCategory} onChange={handleInputChange} required>
